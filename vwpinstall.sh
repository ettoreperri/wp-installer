...
wget https://raw.githubusercontent.com/ettoreperri/wp-installer/master/index.php -O /usr/local/vesta/web/list/wp/index.php 
wget https://raw.githubusercontent.com/ettoreperri/wp-installer/master/api.php -O /usr/local/vesta/web/list/wp/api.php 
wget https://raw.githubusercontent.com/ettoreperri/wp-installer/master/v-sam-create-wp -O /usr/local/vesta/bin/v-sam-create-wp 
